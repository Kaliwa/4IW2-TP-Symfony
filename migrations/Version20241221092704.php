...
final class Version20241221092704 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE chapter (id SERIAL NOT NULL, subject_id_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE comment (id SERIAL NOT NULL, user_id_id INT DEFAULT NULL, exercise_id_id INT DEFAULT NULL, content TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_9474526C9D86650F ON comment (user_id_id)');
        $this->addSql('CREATE INDEX IDX_9474526C5A726995 ON comment (exercise_id_id)');
        $this->addSql('CREATE TABLE exercise (id SERIAL NOT NULL, chapter_id_id INT DEFAULT NULL, question TEXT NOT NULL, response TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, classe_id_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
